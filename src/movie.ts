...
import VsMeta, { IInfo } from './vsmeta'
...
let info: IInfo = {
  ...
  backdrop: fs
    .readFileSync(
      path.resolve(__dirname, '../assets/vLgkglkAOgXzy8sXscFLvidgaTM.jpg')
    )
    .toString('base64'),
  poster: fs
    .readFileSync(
      path.resolve(__dirname, '../assets/bzdtfWDNIVVMCtCAQvgBNK7GHH6.jpg')
    )
    .toString('base64')
}
...
fs.writeFileSync(
  path.resolve(__dirname, '../dist/MVI_1166.MP4.vsmeta'),
  vsmeta.toBuffer()
)
